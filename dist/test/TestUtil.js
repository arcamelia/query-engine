...
exports.addDisk = exports.clearDisk = exports.persistDir = exports.getContentFromCourseZipFiles = exports.getContentFromArchives = void 0;
...
function getContentFromCourseZipFiles(name) {
    return fs.readFileSync("test/resources/addDatasetTests/CoursesZipFiles/" + name).toString("base64");
}
exports.getContentFromCourseZipFiles = getContentFromCourseZipFiles;
function clearDisk() {
